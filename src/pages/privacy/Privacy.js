...
export default (privacyPolicy = () => {
  return (
    <Fragment>
      ...
      <p>Effective date: February 17, 2019</p>

      <p>
        CrunchMyFare ("us", "we", or "our") operates the
        https://crunchmyfare.herokuapp.com website (the "Service").
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for CrunchMyFare is
      ...
      <p>CrunchMyFare uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        CrunchMyFare will take all steps reasonably necessary to ensure that
      ...
      <p>
        CrunchMyFare may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of CrunchMyFare</li>
        <li>
      ...
      <ul>
        <li>By email: pietrosparks@gmail.com</li>
      </ul>
    </Fragment>
  )
})
